...
@Component({
  standalone: true,
  selector: 'app-input-autocomplete-dictionary',
  imports: [CommonModule, IconComponent],
  templateUrl: './input-autocomplete-dictionary.component.html',
})
export class InputAutocompleteDictionaryComponent {
  ...
  dictionary = input.required<'czenas' | 'eczenas'>();
    ...
    effect(() => {
      ...
      this.debounceTimer = window.setTimeout(() => {
        ...
        this.cat
          ...
          .subscribe({
            next: (res: AutocompletDictionaryResponse[]) => {
